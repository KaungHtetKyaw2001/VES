...
<script src="assets/dist/js/jquery.magnify.js"></script>
<script src="assets/dist/js/jquery.magnify-mobile.js"></script>
<script>
$(document).ready(function() {
  $('img').magnify();
});
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js"></script>
 <!-- Next Condition -->
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/my_MM/sdk.js#xfbml=1&version=v15.0&appId=542101520664712&autoLogAppEvents=1" nonce="0JOMADYj"></script>
