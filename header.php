...
<head>
	...
	<link href="assets/dist/css/magnify.css" rel="stylesheet" type="text/css">
	<style>
					...
					<div class="menu">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="specialitem.php">Videos</a></li>
								</ul>
							</li>

							<li>
								<a href="about.php">About VES</a>
								<ul>
									<li><a href="contact.php">Contact VES</a></li>
