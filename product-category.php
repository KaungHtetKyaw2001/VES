...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_product_category; ?>)">
    <div class="inner">
        <h1 class="wow animate__animated animate__slideInDown" data-wow-offset="150"data-wow-delay="1"><?php echo LANG_VALUE_50; ?> <?php echo $title; ?></h1>
    </div>
</div>
...
<div class="page">
    <div class="container">
        <div class="row">
          <div class="col-md-3 wow animate__animated animate__slideInLeft" data-wow-offset="150" data-wow-delay="1">
                <?php require_once('sidebar-category.php'); ?>
            </div>
            <div class="col-md-9">
                
                <h3><?php echo LANG_VALUE_51; ?> "<?php echo $title; ?>"</h3>
                <div class="product product-cat wow animate__animated animate__slideInUp" data-wow-offset="150" data-wow-delay="1">
