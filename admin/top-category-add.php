...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Main Menu can not be empty<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Main Menu already exists<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Main Menu is added successfully.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Main Menu Name <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="tcat_name">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Show on Menu bar? <span>*</span></label>
							<div class="col-sm-4">
