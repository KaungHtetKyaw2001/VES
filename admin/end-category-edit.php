...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "You must have to select a Sub Menu<br>";
    }

    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "Last Menu name can not be empty<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Last Menu is updated successfully.';
    }
}
?>
