...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Gem Products</h1>
	</div>
	<div class="content-header-right">
		<a href="gproduct-add.php" class="btn btn-primary btn-sm">Add Gem Product</a>
	</div>
</section>
				...
				<div class="box-body table-responsive">
					...
					<thead class="thead-dark">
							<tr>
								<th width="10">#</th>
								<th>Photo</th>
                                <th width="160">Gem Code</th>
								<th width="160">Gem Product Name</th>
								<th width="60">Created Date</th>
								<th width="160">Size ( in mm )</th>
								<th width="160">Weight ( in Ct)</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:82px;"><img src="../assets/uploads/<?php echo $row['p_featured_photo']; ?>" alt="<?php echo $row['g_name']; ?>" style="width:80px;"></td>
									...
									<td>										
										<a href="gproduct-edit.php?id=<?php echo $row['p_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="#" class="btn btn-danger btn-xs" data-href="gproduct-delete.php?id=<?php echo $row['p_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
									</td>
								</tr>
								<?php
							}
