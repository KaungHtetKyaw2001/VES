...
if(isset($_POST['form_specialitem'])) {
    ...
    if($valid == 1) {
        ...
        // }
            ...
            // updating the database
            $statement = $pdo->prepare("INSERT INTO `videos`(`v_id`,`v_url`,`v_date`,`v_uni_no`) VALUES(?,?,?,?)");
            $statement->execute(array($_POST['video_id'],$_POST['video_link'],$_POST['video_upload_date'],$_POST['video_unique_no']));
