...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $faq_banner; ?>);">
    <div class="inner">
        <h1 class="wow animate__animated animate__slideInUp" data-wow-offset="150" data-wow-delay="1"><?php echo $faq_title; ?></h1>
    </div>
</div>
...
<div class="page">
    <div class="container">
        <div class="row">            
            <div class="col-md-12 wow animate__animated animate__slideInUp" data-wow-offset="150" data-wow-delay="1">
